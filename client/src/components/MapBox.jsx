...
class MapBox extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.get(`http://127.0.0.1:3001/api/summary/${parsed}`).then((response) => {
      this.setState({
        data: response.data,
      });
    });
